        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo base_url(); ?>index.php/Validasi">Validasi Data</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Hi <?php echo $this->session->userdata('USERNAME'); ?></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo base_url(); ?>index.php/LoginTakmir/logout">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
